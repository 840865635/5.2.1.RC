...
public class TaskManager {
	...
	public List<Task> getPersonalTasks(String loginName, Long companyId, Integer size, String order){
		...
		if(StringUtils.isNotEmpty(order)){
			sql.append(" order by task.read asc,task.displayOrder asc,task."+order+" desc");
		}else{
			sql.append(" order by task.read asc,task.displayOrder asc,task.createdTime desc");
		}
	...
	public List<Task> getDetailTasksByUserType(Long companyId, String loginName, String typeName, Integer size, String order){
		...
		if(StringUtils.isNotEmpty(order)){
			sql.append(" order by t.read asc,t.displayOrder asc,t."+order+" desc");
		}else{
			sql.append(" order by t.read asc,t.displayOrder asc,t.createdTime desc");
		}
		Page<Task> tasks = new Page<Task>(size);
