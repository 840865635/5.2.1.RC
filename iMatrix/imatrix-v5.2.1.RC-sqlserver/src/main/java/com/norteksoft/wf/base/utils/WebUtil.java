...
public class WebUtil {
	 ...
	 * 普通的http请求
	 * @param url
	 * attrValue:办理人登录名集合，多个办理人之间用逗号隔开。当是在更改办理人时，attrValue为新办理人，多个办理人之间用逗号隔开；当是在增加办理人时，attrValue为新增加的办理人，多个办理人之间用逗号隔开；当是减少办理人时，attrValue为被减少的办理人登录名，多个办理人之间用逗号隔开
	 */
