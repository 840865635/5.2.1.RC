...
public class TimerUtils {
	...
	public boolean neetReminder(WorkflowTask task){
		return (task.getLastReminderTime()== null && ((System.currentTimeMillis()-task.getCreatedTime().getTime())>task.getDuedate()*MILLI_SECOND) && (!isHolidayDate())) ||
		(task.getLastReminderTime()!= null && ((System.currentTimeMillis()-task.getLastReminderTime().getTime())>task.getRepeat()*MILLI_SECOND) && (!isHolidayDate()));
	}
