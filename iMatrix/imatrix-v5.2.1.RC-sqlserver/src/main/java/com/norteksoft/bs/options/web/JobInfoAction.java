...
public class JobInfoAction extends CrudActionSupport<TimedTask> {
	...
	private String everySecond;//时间间隔：分钟
	
	private String everyHour;//时间间隔：小时
	...
	public String save() throws Exception {
		...
		if(typeEnum!=null||everyMonth!=null||everyWeek!=null||everyDate!=null||appointTime!=null||appointSet!=null
				||everySecond!=null||everyHour!=null){
			...
			if(StringUtils.isNotEmpty(everySecond))
				cornInfo.setEverySecond(everySecond);//时间间隔：分钟
			if(StringUtils.isNotEmpty(everyHour))
				cornInfo.setEveryHour(everyHour);//时间间隔：小时	
