...
public class FileServiceTest extends BaseWorkflowTestCase {
	...
	public void saveFile() throws IOException{
		...
		String result = ApiFactory.getFileService().saveFile(file);
	...
	public void saveFileTwo() throws IOException{
		...
		String result = ApiFactory.getFileService().saveFile(fileBody);
		Assert.assertNotNull(result);
	}
	...
	public void getFile() throws IOException{
		...
		FileOutputStream fos  = new FileOutputStream(file);
		fos.write("FileServiceTest：saveFile()".getBytes());
		String filePath = ApiFactory.getFileService().saveFile(file);
