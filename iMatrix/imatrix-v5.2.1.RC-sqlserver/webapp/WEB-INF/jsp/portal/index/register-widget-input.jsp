		...
		<form id="inputForm" name="inputForm" action="" method="post">
			...
			<table class="form-table-without-border">
				...
				<tr>
					<td >默认位置：</td>
					<td> 
						<input type="radio" name="position" value="0"  <s:if test="position==0">checked="checked"</s:if> />左栏
						<input type="radio" name="position" value="1"  <s:if test="position==1">checked="checked"</s:if> />中栏
						<input type="radio" name="position" value="2"  <s:if test="position==2">checked="checked"</s:if> />右栏
					</td>
				</tr>
				<tr>
					<td >权限设置：</td>
