...
public class MmsServiceImpl implements MmsService {
	...
	public Menu getParent(String code) {
		return BeanUtil.turnToModelMenu(menuManager.getParentMenu(code));
	}

	public List<Menu> getChildren(String code) {
		return BeanUtil.turnToModelMenuList(menuManager.getChildren(code));
	}
}
