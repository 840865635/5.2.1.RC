...
public class ApiFactory {
	...
	public static CommonTaskService getCommonTaskService(){
		return (CommonTaskService)ContextUtils.getBean("commonTaskServiceImpl");
	}
	/**
	 * 数据规则api
	 */
	public static DataRuleService getDataRuleService(){
		return (DataRuleService)ContextUtils.getBean("dataRuleServiceImpl");
	}
	/**
	 * 数据授权api
	 */
	public static DataPermissionService getDataPermissionService(){
		return (DataPermissionService)ContextUtils.getBean("dataPermissionServiceImpl");
	}
}
