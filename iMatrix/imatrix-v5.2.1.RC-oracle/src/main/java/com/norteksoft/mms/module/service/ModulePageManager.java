...
public class ModulePageManager {
	...
	public List<ModulePage> getDraftOrEnablePagesByMenuId(Long menuId) {
		return modulePageDao.getDraftOrEnablePagesByMenuId(menuId);
	}
	 ...
	 */
	@Transactional(readOnly=false)
	public void deleteButtons(Long pageId) {
		buttonDao.deleteButtonByModulePage(pageId);
	}
	 ...
	 * @return
	 */
	public ModulePage getModulePageByCode(String code) {
		return modulePageDao.getModulePage(code);
	}
}
