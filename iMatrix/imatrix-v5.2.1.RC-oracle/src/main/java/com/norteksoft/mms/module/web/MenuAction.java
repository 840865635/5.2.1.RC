...
public class MenuAction extends CrudActionSupport<Menu>{
	...
	public String menuTree() throws Exception{
		...
		for(Menu menu :menus){
			if(menu.getChildren()==null||menu.getChildren().isEmpty()){
				tree.append(generateJsTreeNodeNew(menu.getId().toString(), "close",  menu.getName()+"("+this.getText(menu.getEnableState().code)+")", "")).append(",");
			}else{
				tree.append(generateJsTreeNodeNew(menu.getId().toString(), "close",  menu.getName()+"("+this.getText(menu.getEnableState().code)+")", childMenu(menu.getChildren()),"")).append(",");
			}
		}
	 ...
	 * @return
	 */
	private String generateJsTreeNodeNew(String id, String state, String data,String rel){
		StringBuilder node = new StringBuilder();
		node.append("{ \"attr\": {").append("\"id\" : \"").append(id).append("\" ,\"rel\":\"").append(rel).append("\" ,\"title\" : \"").append(data).append("\"").append("}");
	 ...
	 * @return
	 */
	private String generateJsTreeNodeNew(String id, String state, String data, String children,String rel){
		StringBuilder node = new StringBuilder();
		node.append("{ \"attr\": {").append("\"id\" : \"").append(id).append("\" ,\"rel\":\"").append(rel).append("\" ,\"title\" : \"").append(data).append("\"").append("}");
		if(state != null && !"".equals(state.trim())){
			node.append(",\"state\" : \"").append(state).append("\"");
