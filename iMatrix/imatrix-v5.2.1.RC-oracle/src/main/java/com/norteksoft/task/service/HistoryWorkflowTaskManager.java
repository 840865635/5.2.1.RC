...
public class HistoryWorkflowTaskManager {
	...
	public Page<HistoryWorkflowTask> getTaskAsTrustee(Long companyId,
			Page<HistoryWorkflowTask> tasks, String loginName, Boolean isEnd) {
		return historyWorkflowTaskDao.getTaskAsTrustee(companyId, loginName, tasks, isEnd);
	}
	/**
	...
	public Page<HistoryWorkflowTask> getHistoryDelegateTasksByActive(
		...
		return historyWorkflowTaskDao.getHistoryDelegateTasksByActive(companyId, loginName, historyTasks);
	}
	...
	public Map<String,Integer> getTotalOverdueTasksNumByTransactor(Long companyId) {
		List<HistoryWorkflowTask> list=historyWorkflowTaskDao.getTotalOverdueTasks(companyId);
