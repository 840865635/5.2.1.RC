...
<div class="ui-layout-center">
	<div class="opt-body">
		<aa:zone name="acs_button">
			<div class="opt-btn">
				<security:authorize ifAnyGranted="roleToUser"><button  class='btn' onclick="submitFormAuthorization('department');"><span><span>保存</span></span></button></security:authorize>
		...
		<aa:zone name="acs_content">
			<div id="opt-content">
				...
				<div class="content_div">
					<acsTags:tree treeId="departmentTree" defaultable="true" treeType="DEPARTMENT_TREE" multiple="true"></acsTags:tree>
				</div>
			</div>
		</aa:zone>
	</div>
