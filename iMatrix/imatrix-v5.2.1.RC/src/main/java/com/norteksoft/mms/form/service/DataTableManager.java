			...
			for (TableColumn column : columns) {
				...
				case COLLECTION:
					if(StringUtils.isNotEmpty(column.getObjectPath())){
						...
						attrList.add("COLLECTION_List<"+collectionName+"> "+attrName+"_"+column.getCasual());
				...
				case REFERENCE:
					if(StringUtils.isNotEmpty(column.getObjectPath())){
						...
						if(RelationSetting.ONE_TO_ONE.equals(column.getRelationSetting())){
							attrList.add("ONETOONE_"+refName+" "+attrName+"_"+column.getCasual());
						}else if(RelationSetting.MANY_TO_ONE.equals(column.getRelationSetting())){
							attrList.add("MANYTOONE_"+refName+" "+attrName+"_"+column.getCasual());
						}else if(RelationSetting.IMPLANT.equals(column.getRelationSetting())){
							attrList.add("IMPLANT_"+refName+" "+attrName+"_"+column.getCasual());
							haveImplant=true;
						}
