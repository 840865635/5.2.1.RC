...
//    }
    ...
    */
    ...
    private static String getMyProcessHistoryPermissions(String processId){
		...
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		XPath x = document.createXPath("/wf:process/wf:extend/wf:access-right/wf:view-flow-history/wf:user-condition");   
		x.setNamespaceURIs(xmlMap);
		Node node = x.selectSingleNode(document);
		if(node==null){
			return null;
     ...
     * @return
     */
    public static String getProcessMeetingPermissions(String processId){
    	String result = (String)WorkflowMemcachedUtil.get(getHashCode(processId+"=processMeetingPermissions"));
    	if(result == null){
			result = getMyProcessMeetingPermissions(processId);
		}else{
			if(DEFAULT_VALUE.equals(result)){
				result = null;
			}
    ...
    private static String getMyProcessMeetingPermissions(String processId){
    	Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		XPath x = document.createXPath("/wf:process/wf:extend/wf:access-right/wf:view-subscribe-result/wf:user-condition");   
		x.setNamespaceURIs(xmlMap);
		Node node = x.selectSingleNode(document);
		if(node==null){
			return null;
     ...
     * @return
     */
    public static String getProcessVotePermissions(String processId){
    	String result = (String)WorkflowMemcachedUtil.get(getHashCode(processId+"=processVotePermissions"));
    	if(result == null){
			result = getMyProcessVotePermissions(processId);
		}else{
			if(DEFAULT_VALUE.equals(result)){
				result = null;
			}
    ...
    private static String getMyProcessVotePermissions(String processId){
    	Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		XPath x = document.createXPath("/wf:process/wf:extend/wf:access-right/wf:view-vote-result/wf:user-condition");   
		x.setNamespaceURIs(xmlMap);
		Node node = x.selectSingleNode(document);
		if(node==null){
			return null;
...
//	}
	...
	private static Map<String,String[]> getMyActivityPermissionCondition(String processId,String taskName){
    	...
    	//查看意见
    	permissionConditions.put("opinionVisible", activityCondition(document,"/wf:process/wf:*[@name='"+taskName+"']/wf:extend/wf:right-settings/wf:view-opinion-right/wf:condition-set"));
    	//查看流转历史
    	...
    	String[] rightSetting = documentEditableCondition(document,"/wf:process/wf:*[@name='"+taskName+"']/wf:extend/wf:right-settings/wf:official-text-right/wf:edit-right");
    	//编辑正文
    	permissionConditions.put("documentEditable",rightSetting );
    	//是否保留痕迹
    	permissionConditions.put("documentTraceRetainable", rightSetting);
    	//是否查看编辑痕迹
    	permissionConditions.put("documentTraceVisible", rightSetting);
    	//打印正文
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String,String> getChangeTransactorSet(String processId) {
		Map<String,String> result = (Map<String,String>)WorkflowMemcachedUtil.get(getHashCode(processId+"=changeTransactorSet"));
		if(result==null)result=getMyChangeTransactorSet(processId);
		return result;
	}
	private static Map<String,String> getMyChangeTransactorSet(String processId) {
		Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		...
		Node node = x.selectSingleNode(document);
		String setType = node==null?"":node.getText();
		x = document.createXPath("/wf:process/wf:extend/wf:expiation-setting/wf:change-transactor");   
		x.setNamespaceURIs(xmlMap);  
		node = x.selectSingleNode(document);
		String changeTransactorMonitor = node==null?"":node.getText();
		Map<String,String> map=new HashMap<String, String>();
		map.put(SET_TYPE, setType);
		map.put(CHANGE_TRANSACTOR_MONITOR, changeTransactorMonitor);
		return map;
	}
	/**
	 * 获得业务补偿/流程监控增加办理人的设置
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String,String> getAddTransactorSet(String processId) {
		Map<String,String> result = (Map<String,String>)WorkflowMemcachedUtil.get(getHashCode(processId+"=addTransactorSet"));
		if(result==null)result=getMyAddTransactorSet(processId);
		return result;
	}
	private static Map<String,String> getMyAddTransactorSet(String processId) {
		Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		...
		Node node = x.selectSingleNode(document);
		String setType = node==null?"":node.getText();
		x = document.createXPath("/wf:process/wf:extend/wf:expiation-setting/wf:add-transactor");   
		x.setNamespaceURIs(xmlMap);  
		node = x.selectSingleNode(document);
		String addTransactorMonitor = node==null?"":node.getText();
		Map<String,String> map=new HashMap<String, String>();
		map.put(SET_TYPE, setType);
		map.put(ADD_TRANSACTOR_MONITOR, addTransactorMonitor);
		return map;
	}
	/**
	 * 获得业务补偿/流程监控减少办理人的设置
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String,String> getDeleteTransactorSet(String processId) {
		Map<String,String> result = (Map<String,String>)WorkflowMemcachedUtil.get(getHashCode(processId+"=deleteTransactorSet"));
		if(result==null)result=getMyDeleteTransactorSet(processId);
		return result;
	}
	private static Map<String,String> getMyDeleteTransactorSet(String processId) {
		Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		...
		Node node = x.selectSingleNode(document);
		String setType = node==null?"":node.getText();
		x = document.createXPath("/wf:process/wf:extend/wf:expiation-setting/wf:delete-transactor");   
		x.setNamespaceURIs(xmlMap);  
		node = x.selectSingleNode(document);
		String deleteTransactorMonitor = node==null?"":node.getText();
		Map<String,String> map=new HashMap<String, String>();
		map.put(SET_TYPE, setType);
		map.put(DELETE_TRANSACTOR_MONITOR, deleteTransactorMonitor);
		return map;
	}
	/**
	 * 获得业务补偿/任务指派的设置
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String,String> getAssignTransactorSet(String processId) {
		Map<String,String> result = (Map<String,String>)WorkflowMemcachedUtil.get(getHashCode(processId+"=assignTransactorSet"));
		if(result==null)result=getMyAssignTransactorSet(processId);
		return result;
	}
	private static Map<String,String> getMyAssignTransactorSet(String processId) {
		Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
		HashMap<String,String> xmlMap = new HashMap<String,String>();   
		xmlMap.put("wf",namespaceUrl);   
		...
		Node node = x.selectSingleNode(document);
		String setType = node==null?"":node.getText();
		x = document.createXPath("/wf:process/wf:extend/wf:expiation-setting/wf:resign-transactor");   
		x.setNamespaceURIs(xmlMap);  
		node = x.selectSingleNode(document);
		String assignTransactor = node==null?"":node.getText();
		Map<String,String> map=new HashMap<String, String>();
		map.put(SET_TYPE, setType);
		map.put(ASSIGN_TRANSACTOR, assignTransactor);
		return map;
	}
	...
	@SuppressWarnings("unchecked")
	public static Map<String,String> getExtendFields(String processId, String taskName){
		Map<String,String>  result = (Map<String,String>)WorkflowMemcachedUtil.get(getHashCode(processId+"=extendFields"));
		if(result == null)result = getMyExtendFields(processId,taskName);
		return result;
	}
	private static Map<String,String> getMyExtendFields(String processId, String taskName){
		Map<String,String> extendFieldMap=new HashMap<String, String>();
		Document document = DocumentParameterUtils.getDocument(processId);
		String namespaceUrl = document.getRootElement().getNamespace().getURI();
 		HashMap<String,String> xmlMap = new HashMap<String,String>();   
 		xmlMap.put("wf",namespaceUrl);   
    	XPath x = document.createXPath("/wf:process/wf:task[@name='"+taskName+"']/wf:extend/wf:extend-field");   
 		x.setNamespaceURIs(xmlMap);  
 		Node node = x.selectSingleNode(document);
	...
	private static void getDefinitionParseTacheInfo(List<Element> nodes,String processId,String tacheType ){
		for(Element element : nodes){
				...
				if("task".equals(tacheType)){
					...
					MemCachedUtils.add(getHashCode(processId+"=extendFields="+name), getMyExtendFields(processId,name));
	...
	private static void getDefinitionParseProcess(String processId){
		...
		value = getMyProcessMeetingPermissions( processId);
		MemCachedUtils.add(getHashCode(processId+"=processMeetingPermissions"), value==null?DEFAULT_VALUE:value);
		
		value = getMyProcessVotePermissions( processId);
		MemCachedUtils.add(getHashCode(processId+"=processVotePermissions"), value==null?DEFAULT_VALUE:value);
		...
		MemCachedUtils.add(getHashCode(processId+"=changeTransactorSet"), getMyChangeTransactorSet( processId));
		MemCachedUtils.add(getHashCode(processId+"=addTransactorSet"), getMyAddTransactorSet( processId));
		MemCachedUtils.add(getHashCode(processId+"=deleteTransactorSet"), getMyDeleteTransactorSet( processId));
		MemCachedUtils.add(getHashCode(processId+"=assginTransactorSet"), getMyAssignTransactorSet( processId));
	...
	public static final String CHANGE_TRANSACTOR_MONITOR="changeTransacotrMonitor";
	public static final String ADD_TRANSACTOR_MONITOR="addTransacotrMonitor";
	public static final String DELETE_TRANSACTOR_MONITOR="deleteTransacotrMonitor";
	public static final String ASSIGN_TRANSACTOR="assginTransacotr";
