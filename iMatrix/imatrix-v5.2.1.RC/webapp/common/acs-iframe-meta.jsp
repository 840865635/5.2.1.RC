...
<%@page import="com.norteksoft.product.util.WebContextUtils"%><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<script src="${acsCtx}/js/acs.js" type="text/javascript"></script>
