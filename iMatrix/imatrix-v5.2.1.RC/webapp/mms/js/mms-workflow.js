...
function saveOpinion(){
	if($("#opinions").attr("value")==""){
		...
		$("#approveOpinion").attr("value",$("#opinions").attr("value"));
		ajaxAnyWhereSubmit("officeForm", webRoot+"/common/save-opinion.htm", "default_opinion_zone",save_opinion_call_back);
	}
}

function save_opinion_call_back(){
	$("#doneOpinion").attr("value","true");
}
