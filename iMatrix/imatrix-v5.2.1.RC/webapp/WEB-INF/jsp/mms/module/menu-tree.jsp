	...
	<script type="text/javascript">
		...
		function importCustomSystem(){
			$.colorbox({href:'${mmsCtx}/module/show-import-custom-system.htm',
				iframe:true, innerWidth:350, innerHeight:100,overlayClose:false,title:"导入自定义系统"});
		}
	</script>
	<style type="text/css">
		.tree ul{
...
<div class="ui-layout-center">
	...
	<form action="" method="post" name="defaultForm" id="defaultForm"></form>
		<div class="opt-btn">
			...
			<!-- 
			<button class="btn" onclick="exportCustomSystem();"><span><span >导出自定义系统</span></span></button>
			
			<s:if test='#versionType=="online"'>
				<button class="btn" onclick="demonstrateOperate();"><span><span >导入自定义系统</span></span></button>
			</s:if><s:else>
				<button class="btn" onclick="importCustomSystem();"><span><span >导入自定义系统</span></span></button>
			</s:else>
			 -->
		</div>
		<div id="opt-content">
