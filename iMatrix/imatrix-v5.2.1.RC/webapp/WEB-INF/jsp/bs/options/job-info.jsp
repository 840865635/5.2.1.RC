...
<head>
	...
	<script type="text/javascript">
		...
		function openPage(url,titles){
			$.colorbox({href:url,iframe:true, innerWidth:700, innerHeight:500,overlayClose:false,title:titles});
		}
		...
		<aa:zone name="groups_main">
			<div class="opt-btn">
				...
				<s:if test='#versionType=="online"'>
					<a class="btn" href="#" onclick="demonstrateOperate();"><span><span >禁用</span></span></a>
				</s:if><s:else>
