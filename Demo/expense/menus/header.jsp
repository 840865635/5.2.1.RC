<%@ page contentType="text/html;charset=UTF-8" import="com.norteksoft.product.util.WebContextUtils,java.text.SimpleDateFormat,java.util.Calendar,com.norteksoft.product.util.SystemUrls"%>
...
<div id="header" class="ui-north">
	...
	<div id="honorific">
		<span><span class="man">&nbsp;</span><%=WebContextUtils.getHonorificTitle()%>, 您好!</span>
