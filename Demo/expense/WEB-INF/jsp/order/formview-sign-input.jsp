...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body onload="getContentHeight();">
		...
		<div class="opt-body">
				<aa:zone name="main">
					<div class="opt-btn">
						<button class='btn' onclick="submitForm('${ctx}/order/save.htm','formviewSign')"><span><span>保存</span></span></button>
					</div>
					...
					<div style="display: none;" id="message"><s:actionmessage theme="mytheme" /></div>
						<form  id="expenseReportForm" name="expenseReportForm" method="post" action="">
							...
							<grid:formView code="ES_ORDER_FORMVIEW" entity="${order}" signatureVisible="true"></grid:formView>
						</form>
					</div>
					<script type="text/javascript">
						//流程环节设置的必填字段
