...
<script src="${resourcesCtx}/widgets/validation/validate-all-1.0.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		function deleteExpenseReport(){
			...
			aa.submit('contentForm', '${ctx}/report/delete.htm?deleteIds='+ids.join(','), 'main'); 
		}

		function openExpenseReport(id){
			var url='${ctx}/report/input.htm';
			if(id!=undefined){
				url=url+'?id='+id;
			}
			...
			<div class="opt-body">
				<aa:zone name="main">
					<div class="opt-btn">
						...
						<button class='btn' onclick="updateExpenseReport();"><span><span>修改</span></span></button>
					...
					<script type="text/javascript">setTimeout("$('#message').hide('show');",3000);</script>
						<form id="contentForm"  method="post"  action="">
							<grid:jqGrid gridId="expenseReportList" url="${ctx}/report/list-datas.htm" code="ES_REPORT"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
