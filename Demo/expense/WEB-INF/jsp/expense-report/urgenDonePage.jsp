	...
	<script type="text/javascript" src="${ctx}/widgets/workflowEditor/swfobject.js"></script>
		...
		isUsingComonLayout=false;
			...
			function readPersonCallBack(){
				$('#readPersons').attr("title",jstree.getNames());
				$('#readLoginNames').attr("value",jstree.getLoginNames());
			}
			...
			function signPersonCallBack(){
				$('#signPersons').attr("title",jstree.getNames());
				$('#signLoginNames').attr("value",jstree.getLoginNames());
			}
