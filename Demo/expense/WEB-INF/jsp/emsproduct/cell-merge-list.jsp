				...
				<aa:zone name="main">
					...
					<div id="opt-content" >
						<form id="contentForm" name="contentForm" method="post"  action="">
							<grid:jqGrid gridId="productList" url="${ctx}/emsproduct/cell-merge-list-datas.htm" submitForm="sForm" code="PRODUCT_CELL_MERGE" ></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
